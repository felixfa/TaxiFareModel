...
PROJECT_ID=wagon-bootcam-313109
...
LOCAL_PATH="/Users/Felix/code/felixfa/TaxiFareModel/raw_data/train_1k.csv" # Replace with your local path to the `train_1k.csv` and make sure to put it between quotes
